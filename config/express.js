...
// Override one or more of the default middleware (besides bodyParser,
// cookieParser)
// 
// middleware: {
...
// bodyParser: function customBodyParser (options) { ... return function(req,
// res, next) {...}; }
// 

// bodyParser: function(){
// return function(req, res, next){
// console.log('passing EXPRESS bodyParser');
...
// Or you can always revert back to the vanilla parser built-in to
// Connect/Express:
 ...
 * 
 * In Sails, this affects the files in your app's `assets` directory. By
 * default, Sails uses your project's Gruntfile to compile/copy those assets to
 * `.tmp/public`, where they're accessible to Express.
 * 
 * The HTTP static cache is only active in a 'production' environment, since
 * that's the only time Express will cache flat-files.
 * 
 * For more information on configuration, check out:
 * http://sailsjs.org/#documentation
 */
